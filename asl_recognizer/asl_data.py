...
class AslDb(object):
    ...
    def __init__(self,
                 hands_fn=os.path.join('./asl_recognizer/data', 'hands_condensed.csv'),
                 speakers_fn=os.path.join('./asl_recognizer/data', 'speaker.csv')
                 ):
    ...
    def build_training(self, feature_list, csvfilename =os.path.join('./asl_recognizer/data', 'train_words.csv')):
    ...
    def build_test(self, feature_method, csvfile=os.path.join('./asl_recognizer/data', 'test_words.csv')):
